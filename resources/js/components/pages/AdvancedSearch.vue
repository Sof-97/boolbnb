    ...
    <div>
        <div class="container-as">
            <div class="flex posrev search-bar-as">
                <input type="text" class="search-as" placeholder="Inizia a cercare una destinazione"
                    @keyup.enter="select(0)" @keyup="getInfoApi(search)" v-model="search" />
                <div class="filters-as">
                    ...
                    <div id="filter-list" class="show">
                        <ul>
                            <li :key="i" v-for="(e, i) in services">
                                ...
                                <input type="checkbox" :name="e.name" :id="e.id" :value="e.id" v-model="checked" />
                            </li>
                        </ul>
                    </div>

                    <div class="autocomplete" v-show="
                            autocomplete != null &&
                    ...
                    <span>
                        ...
                        <input type="range" name="radius" id="radius" min="5" max="500000" step="5" v-model="range"
                            @change="getApartments(range, lat, lon)" />
                    </span>
                    <input class="stanze-letti" type="number" placeholder="Stanze" v-model="stanze" min="1" max="9" />
            ...
            <div class="container-cards-as">
                <div v-for="(e, i) in apartments" :key="i" class="card-as" v-show="
                    ...
                    <div class="card-body-as">
                        ...
                        <p class="card-price-as"><span>{{ e.price }}€</span> per Notte</p>
                        <router-link :to="{
                                name: 'SingleApartment',
                                params: { slug: e.slug },
                            }" class="button-show">Vai all'appartamento</router-link>
