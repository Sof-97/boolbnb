<template>
    <div class="form-group">
        <input required autocomplete="off" @keyup="addressSearch" type="text" class="form-control address-form"
            name="address" id="address" v-model="address" placeholder="Indirizzo" />
        ...
        <div class="address-form2" v-show="results.length > 0">
                <ul class="list-type">
                <li :key="i" v-for="(result, i) in results" @click="selectAddress(i)" style="cursor: pointer" class="li-hover">
